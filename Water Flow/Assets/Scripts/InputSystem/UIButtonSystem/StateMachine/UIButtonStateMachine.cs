    ...
    public class UIButtonStateMachine
    {
        ...
        public void Init()
        {
            ...
            StateTransitions = new List<Transition>
            {
                ...
                { new Transition(InteractionStateEnum.PressDown, CommandEnum.DragBegin, InteractionStateEnum.DragBegin) },
                { new Transition(InteractionStateEnum.PressDown, CommandEnum.PressUp, InteractionStateEnum.PressUp) },
                ...
                { new Transition(InteractionStateEnum.Drag, CommandEnum.Drag, InteractionStateEnum.Drag) },
